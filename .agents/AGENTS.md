...
11. **Redacción en español de Chile:** Todo texto visible para usuarios y todo comentario nuevo debe usar español de Chile, nunca voseo ni modismos rioplatenses. Antes de cerrar cualquier cambio que agregue o modifique texto, revisa también las formas conjugadas, no solo la palabra `vos`: `tenés`, `podés`, `querés`, `necesitás`, `usás`, `cambiás`, y los imperativos `elegí`, `confirmá`, `cargá`, `registrá`, `mirá`, `cerrá`, `hacé`, `guardá`, `creá`, `revisá`, etc. Las formas correctas son `tienes`, `puedes`, `quieres`, `necesitas`, `usas`, `cambias`, `elige`, `confirma`, `carga`, `registra`, `mira`, `cierra`, `haz`, `guarda`, `crea`, `revisa`. Si una coincidencia está en un identificador técnico o en una cita histórica, no la cambies; si está en una interfaz, notificación, correo, mensaje de error o comentario nuevo, corrígela.
