    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.scrollContent}>
      ...
      {user.type === 'organization' && (
        <>
          ...
          {/* Previsualización del Chip — envuelto en un View con alignSelf: 'flex-start'
              porque previewBox (compartido con la previsualización de Pins de abajo,
              que sí necesita estirarse para poder wrappear varios chips) por defecto
              estira a sus hijos, y un solo chip suelto quedaba ocupando todo el ancho. */}
