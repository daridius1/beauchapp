...
export const PeliculaMatchModal: React.FC<Props> = ({ currentUser, matchUser, onNavigateToUser, onClose }) => {
  return (
    <View style={styles.overlay}>
      <View style={styles.popup}>
        <FontAwesome name="heart" size={56} color="#10B981" />
        <Text style={styles.title}>¡Es un Match!</Text>
        <Text style={styles.subtitle}>A vos y a {matchUser?.name || 'esta persona'} les gustan las mismas películas.</Text>
